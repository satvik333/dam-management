    ...
    <nav class="main-header">
      ...
      <div id="menu">
        <div id="menu-toggle">
         ...
         <ul class="text-center text-capitalize nav-agile" style="width: 100%;">
                        <li>
                            <a href="home.jsp">home</a>
                        </li>
                        <li>
                            <a href="SetRange.jsp">Set Range</a>
                        </li>
                        <li>
                            <a href="addReadings.jsp" style="width: 135%;">Add Readings</a>
                        </li>
                        <li style="margin-left: 6%;">
                            <a href="ViewReadings.jsp" style="width: 100px;">View Readings</a>
                        </li>
                        <li style="margin-left: 2%;">
                            <a href="viewaffectedcitys.jsp" style="width: 140%;">Affected Cities</a>
                        </li>
                        <li style="margin-left: 7%;">
                            <a href="../UserLogin.jsp" class="active">LogOut</a>
                        </li>
