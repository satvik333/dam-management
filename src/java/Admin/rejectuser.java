    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
     ...
     response.setContentType("text/html;charset=UTF-8");
        ...
        try {
            ...
            if (del > 0) {
             out.print("<script>alert(\"User Rejected successfully\"); window.location.href=\"admin/viewuser.jsp\";</script>");
            }
             else {
                    out.print("<script>alert(\"User failed to Reject\"); window.history.back();</script>");
                }
            }
